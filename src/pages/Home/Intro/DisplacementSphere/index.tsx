...
import { media, rgbToThreeColor } from '@/utils/styles';
...
export const DisplacementSphere = (
  ...
  //adjust sphere location
  useEffect(() => {
    const { width, height } = windowSize;

    const adjustedHeight = height + height * 0.05;
  ...
  //handle animate when mouse move
  useEffect(() => {
    const onMouseMove = (event: any) => {
      ...
      rotationX.set(position.y / 1.5);
      rotationY.set(position.x / 1.5);
    };
